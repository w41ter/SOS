...
seta20.2:
  ...
  lgdt    gdtdesc
    ...
    7c20:	78 7c                	js     7c9e <read_sect+0xe>
  movl    %cr0, %eax
...
void read_segment(uint8_t *pa, uint32_t count, uint32_t offset)
{
    ...
    7d0c:	76 19                	jbe    7d27 <read_segment+0x40>
		read_sect(pa, offset);
    7d0e:	89 74 24 04          	mov    %esi,0x4(%esp)
    7d12:	89 1c 24             	mov    %ebx,(%esp)
    7d15:	e8 76 ff ff ff       	call   7c90 <read_sect>
	offset = (offset / SECTSIZE) + 1;
    ...
    7d25:	77 e7                	ja     7d0e <read_segment+0x27>
		read_sect(pa, offset);
}
...
void bootmain(void)
{
    ...
    7d4f:	e8 93 ff ff ff       	call   7ce7 <read_segment>
    ...
    7d8f:	e8 53 ff ff ff       	call   7ce7 <read_segment>
